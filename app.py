...
# ----------------- SIDEBAR PARAMETERS -----------------
st.sidebar.markdown("<h3 style='color:#D4AF37; text-align:center; font-weight:600; letter-spacing:0.5px;'>Panel Pengaturan</h3>", unsafe_allow_html=True)
st.sidebar.divider()

# Parameter 1: Sistem Antrean
st.sidebar.markdown("<p style='color:#D4AF37; font-weight:600; margin-bottom:5px;'>1. Konfigurasi Antrean (M/M/c)</p>", unsafe_allow_html=True)
...
st.sidebar.markdown("<p style='color:#D4AF37; font-weight:600; margin-bottom:5px;'>2. Pergerakan Harga Emas</p>", unsafe_allow_html=True)
...
st.sidebar.markdown("<p style='color:#D4AF37; font-weight:600; margin-bottom:5px;'>3. Dinamika Finansial & Bisnis</p>", unsafe_allow_html=True)
...
with tab1:
    ...
    with col_t1_2:
        ...
        fig_hist.add_vline(x=sim_avg_wait, line_dash="dash", line_color="#E5C158", line_width=2,
        ...
        if stats_q["stable"] and analytical_wq != float('inf'):
            fig_hist.add_vline(x=analytical_wq, line_dash="dot", line_color="#8E9BAE", line_width=2,
...
with tab3:
    ...
    with col_t3_2:
        ...
        st.markdown(f"""
        <div style="background-color: #0E1216; border-radius: 12px; padding: 20px; border-left: 4px solid #C5A059; border: 1px solid rgba(255,255,255,0.03);">
...
st.divider()
st.markdown("<p style='text-align: center; color: #475569; font-size: 12px; font-weight: 500;'>Simulasi Sistem Transaksi & Optimalisasi Layanan Buyback Toko Emas - 2026</p>", unsafe_allow_html=True)
